  ...
  return (
    <div className="h-screen bg-gradient-to-br from-mint-cream/50 to-white relative overflow-hidden auth-container">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-20 w-32 h-32 bg-rich-green rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-soft-sage rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-deep-teal rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row h-[calc(100vh-80px)]">
        {/* Left Side - Branding */}
        <div className="hidden lg:flex lg:w-1/2 bg-rich-green relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-rich-green to-forest-teal"></div>
          <div className="relative z-10 flex flex-col justify-center p-8 xl:p-12 text-white">
            <MotionDiv direction="up" className="max-w-lg">
              <h1 className="text-4xl xl:text-5xl font-bold mb-4 xl:mb-6 leading-tight">
                Welcome Back to
                <span className="text-mint-cream block">Roomsy</span>
              </h1>
              <p className="text-lg xl:text-xl text-white/90 mb-8 xl:mb-12 leading-relaxed">
                Continue your journey to find the perfect roommate. Your ideal living situation is just a login away.
              </p>
              ...
              <div className="space-y-4 xl:space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-base xl:text-lg">Secure & Verified</h3>
                    <p className="text-white/80 text-sm xl:text-base">All profiles are identity verified</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-base xl:text-lg">10,000+ Active Users</h3>
                    <p className="text-white/80 text-sm xl:text-base">Join our growing community</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-base xl:text-lg">4.9/5 Rating</h3>
                    <p className="text-white/80 text-sm xl:text-base">Highly rated by our users</p>
                  </div>
                </div>
              </div>
            </MotionDiv>
          ...
          <div className="absolute top-20 right-20 w-32 h-32 bg-mint-cream/20 rounded-full blur-2xl"></div>
        </div>

        {/* Right Side - Login Form */}
        <div className="flex-1 flex items-center justify-center p-4 lg:p-8 xl:p-12 auth-container">

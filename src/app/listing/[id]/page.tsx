  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-soft-sage/5 via-mint-cream/10 to-white flex items-center justify-center">
        <div className="bg-white/90 backdrop-blur-sm border border-rich-green/20 rounded-2xl p-8 text-center">
          <div className="animate-spin w-12 h-12 border-4 border-rich-green border-t-transparent rounded-full mx-auto mb-4"></div>
          <h2 className="text-xl font-bold text-rich-green mb-2">Loading listing details...</h2>
          <p className="text-rich-green/70">Please wait while we fetch the information</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-soft-sage/5 via-mint-cream/10 to-white flex items-center justify-center">
        <div className="bg-white/90 backdrop-blur-sm border border-rich-green/20 rounded-2xl p-8 text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-rich-green mb-2">Listing Not Found</h2>
          <p className="text-rich-green/70 mb-6">Sorry, we couldn&apos;t find this listing. It may have been removed or the link is incorrect.</p>
        ...
        <div className="max-w-7xl mx-auto container-spacing py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button className="p-2 rounded-lg bg-white/80 text-rich-green hover:scale-110 transition-transform border border-rich-green/10">
      ...
      <div className="max-w-7xl mx-auto container-spacing py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="p-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        {images.slice(1, 5).map((src: string, i: number) => (
                          <div key={i + 1} className="relative h-24 overflow-hidden rounded-lg">
                            <Image 
                              src={src} 
                        ...
                        {images.length > 5 && (
                          <div className="relative h-24 bg-rich-green/10 rounded-lg flex items-center justify-center">
                            <span className="text-rich-green font-medium text-sm">
            ...
            {/* Listing Details */}
            <div className="bg-white/95 backdrop-blur-sm border border-rich-green/20 rounded-2xl shadow-lg p-8">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h1 className="text-3xl font-bold text-rich-green mb-2">{listing.title}</h1>
                  <div className="flex items-center space-x-4 text-rich-green/70">
                ...
                <div className="text-right">
                  <div className="text-3xl font-bold text-rich-green">
              ...
              <div className="prose prose-rich-green max-w-none mb-8">
                <p className="text-rich-green/80 leading-relaxed whitespace-pre-line">
                  {listing.description}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-gradient-to-br from-mint-cream/50 to-soft-sage/30 rounded-xl">
                  <Home className="w-8 h-8 text-rich-green mx-auto mb-2" />
                ...
                <div className="text-center p-4 bg-gradient-to-br from-mint-cream/50 to-soft-sage/30 rounded-xl">
                  <Users className="w-8 h-8 text-rich-green mx-auto mb-2" />
                ...
                <div className="text-center p-4 bg-gradient-to-br from-mint-cream/50 to-soft-sage/30 rounded-xl">
                  <Clock className="w-8 h-8 text-rich-green mx-auto mb-2" />
              ...
              {/* Location */}
              <div>
                <h3 className="font-bold text-rich-green mb-4 flex items-center">
                  <MapPin className="w-5 h-5 mr-2" />
                  Location
                </h3>
                <div className="bg-gradient-to-r from-rich-green/5 to-soft-sage/10 p-4 rounded-xl border border-rich-green/20 mb-4">
                  <p className="text-rich-green/80">{location}</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-rich-green/20 rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-rich-green to-soft-sage rounded-full flex items-center justify-center text-white text-xl font-bold">
                  {listing.user?.name?.charAt(0)?.toUpperCase() || 'U'}
                </div>
                <div>
                  <div className="flex items-center space-x-2">
                    <h4 className="font-semibold text-rich-green">{listing.user?.name || "Unknown"}</h4>
                    {listing.user?.isVerified && (
                      <Shield className="w-4 h-4 text-green-500" />
                    )}
                  </div>
                  <p className="text-sm text-rich-green/70">{listing.user?.city || ""}</p>
                  {listing.user?.profession && (
                    <p className="text-xs text-rich-green/60">{listing.user.profession}</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                {listing.user?.university && (
                  <div className="flex items-center space-x-2 text-sm">
                    <div className="w-8 h-8 bg-mint-cream rounded-lg flex items-center justify-center">
                      🎓
                    </div>
                    <span className="text-rich-green/80">{listing.user.university}</span>
                  </div>
                )}
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-8 h-8 bg-mint-cream rounded-lg flex items-center justify-center">
              ...
              <div className="space-y-3">
                {isOwner ? (
                  <Link 
                    ...
                    className="flex items-center justify-center space-x-2 bg-rich-green text-white px-6 py-3 rounded-xl font-medium hover:bg-rich-green/90 transition-colors w-full"
                  >
                  ...
                  <>
                    <button className="flex items-center justify-center space-x-2 bg-rich-green text-white px-6 py-3 rounded-xl font-medium hover:bg-rich-green/90 transition-colors w-full">
                      <MessageCircle className="w-4 h-4" />
                      <span>Contact Owner</span>
                    </button>
                    <Link 
                      href={`/profile/${listing.user?.id}`}
                      className="flex items-center justify-center space-x-2 bg-white border-2 border-rich-green text-rich-green px-6 py-3 rounded-xl font-medium hover:bg-rich-green/5 transition-colors w-full"
                    >
            ...
            {!isOwner && (
              <div className="bg-white/95 backdrop-blur-sm border border-rich-green/20 rounded-2xl shadow-lg p-6">
                <h3 className="font-bold text-rich-green mb-4">Quick Contact</h3>
                <div className="space-y-3">

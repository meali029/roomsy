...
function BannedUsersList({ initialBannedUsers }: BannedUsersListProps) {
...
export default function AdminBannedUsersPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Banned Users Management</h1>
        <p className="text-gray-600">Review and manage banned users</p>
      </div>
      
      <BannedUsersList initialBannedUsers={bannedUsers} />
    </div>
  )
}
